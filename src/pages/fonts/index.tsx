...
import { silka, antonio, nudica, spaceGrotesk, tiro, poppins, inter, unna, prata, dmSerifDisplay, lora, bungee, monoton, rampartOne, anton } from "@/lib/fonts/index";
...
function FontShowcase({ font, fontIs, className }: { font: NextFontWithVariable | NextFont; fontIs: string; className?: string }) {
    return (
